 ...
 * @author gyao
 */
public class PerceivedRelationalChoice extends AbstractQuestionRelation {

    private static final long serialVersionUID = 1957199626453096185L;
    private static Log logger = LogFactory.getLog(PerceivedRelationalChoice.class);
    private Map<Long, Map<Long, Edge>> fromNodeToNodeEdgeMap;

    public PerceivedRelationalChoice(Question currentQuestion) {
        super(currentQuestion);
    }

    public PerceivedRelationalChoice(Node respondent, Question currentQuestion) {
