...
public class GmapRO {
	...
	public GmapVisData getLocalNetwork(Map request){
    	logger.info("************************** get local network for gmap...");
        ...
        logger.debug("converting to gmap readable data...");
        GmapVisData d = new GmapVisData(nodes, edges); 
        
        logger.debug("************************** get local network for gmap done");
        
        return d;
    }

    @SuppressWarnings("unchecked")
	public GmapVisData getCustomNetwork(Map request){   
    	logger.debug("************************** get custom network for gmap ...");
    	List<String> edgeTypes = (List<String>)request.get("edgeTypes");
        ...
        logger.debug("************************** get custom network for gmap done");
